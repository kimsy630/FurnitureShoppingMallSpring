...
<body>
    ...
    <div id="content">
    	<form action="${pageContext.request.contextPath}/joinAction.cc" method="post" class="signupInfo" name="joinform" onsubmit="return joinCheck();">
    		...
    		<fieldset>
    			...
    			<table cellspacing="0">
    				<tr>
    					<td>회원구분</td>
    					<td>
    							<input class="firstInput" type="radio" name="mb_authority" value="ROLE_USER" onclick="changeClassifi();" checked >일반회원
    							<input type="radio" name="mb_authority" value="ROLE_MANAGER" onclick="changeClassifi();">사업자
    					</td>
    				</tr>
    				<tr>
    					<td>*아이디</td>
    				...
    				<tr>
    					<td colspan="2">
    						...
    						<input type="reset" value="취소"
    							onclick="window.location='index.cc'">
    					</td>
    				<tr>
    			</table>
    		</fieldset>
